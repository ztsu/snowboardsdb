...
// NewBrandCataloguesLoader creates a new BrandCataloguesLoader given a fetch, wait, and maxBatch
func NewBrandCataloguesLoader(config BrandCataloguesLoaderConfig) *BrandCataloguesLoader {
	return &BrandCataloguesLoader{
		fetch:    config.Fetch,
		wait:     config.Wait,
...
type BrandCataloguesLoader struct {
	...
	batch *brandCataloguesLoaderBatch
...
func (l *BrandCataloguesLoader) LoadThunk(key int) func() ([]*snowboards.Catalogue, error) {
	...
	if l.batch == nil {
		l.batch = &brandCataloguesLoaderBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (l *BrandCataloguesLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}
...
func (b *brandCataloguesLoaderBatch) keyIndex(l *BrandCataloguesLoader, key int) int {
...
func (b *brandCataloguesLoaderBatch) startTimer(l *BrandCataloguesLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *brandCataloguesLoaderBatch) end(l *BrandCataloguesLoader) {
